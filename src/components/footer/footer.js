export class FooterCustom extends HTMLElement {
  ...
  <div class="h-auto w-[200px] flex gap-4 flex-wrap">
    ...
    <div class="flex gap-10 font-light">
      <ul class="leading-7 space-y-1">
        <li>
          <a href="/index.html?v=4.0.0" class="group relative inline-block cursor-pointer transition-colors duration-300 hover:text-text-details">
        ...
        <li>
          <a href="/src/pages/about/index.html?v=4.0.0" class="group relative inline-block cursor-pointer transition-colors duration-300 hover:text-text-details">
            <span class="relative after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-text-details after:transition-all after:duration-300 group-hover:after:w-full">
              Sobre
            </span>
          </a>
      ...
      <ul class="leading-7 space-y-1">
        <li>
          <a href="/src/pages/blog/index.html?v=4.0.0" class="group relative inline-block cursor-pointer transition-colors duration-300 hover:text-text-details">
            <span class="relative after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-text-details after:transition-all after:duration-300 group-hover:after:w-full">
              Blog
            </span>
          </a>
        ...
        <li>
          <a href="/src/pages/contact/index.html?v=4.0.0" class="group relative inline-block cursor-pointer transition-colors duration-300 hover:text-text-details">
            <span class="relative after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-text-details after:transition-all after:duration-300 group-hover:after:w-full">
              Contato
            </span>
          </a>
  ...
  <div class="h-auto flex flex-col gap-4 w-[300px] mt-6 sm:mt-0">
    ...
    <ul class="leading-7 space-y-1 font-light">
      <li>
        <a href="/src/pages/solutions/civil/index.html?v=4.0.0" class="group relative inline-block cursor-pointer transition-colors duration-300 hover:text-text-details">
          <span class="relative after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-text-details after:transition-all after:duration-300 group-hover:after:w-full">
      ...
      <li>
        <a href="/src/pages/solutions/industrial/index.html?v=4.0.0" class="group relative inline-block cursor-pointer transition-colors duration-300 hover:text-text-details">
          <span class="relative after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-text-details after:transition-all after:duration-300 group-hover:after:w-full">
      ...
      <li>
        <a href="/src/pages/solutions/projects/index.html?v=4.0.0" class="group relative inline-block cursor-pointer transition-colors duration-300 hover:text-text-details">
          <span class="relative after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-text-details after:transition-all after:duration-300 group-hover:after:w-full">
  ...
  target="_blank" class="group relative inline-block cursor-pointer transition-colors duration-300 hover:text-text-details">
      ...
      <a href="https://www.linkedin.com/company/capella-solu%C3%A7%C3%B5es-em-engenharia/posts/?feedView=all&viewAsMember=true" class="transition-transform duration-300 hover:scale-110">
        <img src="/public/images/icons/linkedin.svg?v=4.0.0" alt="LinkedIn" class="w-6 h-6" />
      </a>
      <a href="https://www.instagram.com/capella.eng?utm_source=qr&igsh=ZWd2ZXVmaGVwMzl6" class="transition-transform duration-300 hover:scale-110">
        <img src="/public/images/icons/instagram.svg?v=4.0.0" alt="LinkedIn" class="w-6 h-6" />
      </a>
    </div>
  </div>
