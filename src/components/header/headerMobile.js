  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      ...
      <ul id="mobile-menu"
        ...
        <li><a href="/index.html?v=6.0.0" class="block py-2 px-2 hover:bg-shadow-secondary rounded transition-colors">Home</a></li>
        <li><a href="/src/pages/about/index.html?v=6.0.0" class="block py-2 px-2 hover:bg-shadow-secondary rounded transition-colors">Sobre</a></li>
        ...
        <ul id="submenu-solucoes" class="hidden flex-col pl-4 space-y-1">
          <li>
            <a href="/src/pages/solutions/civil/index.html?v=6.0.0" class="block py-2 px-2 text-sm hover:bg-shadow-secondary rounded transition-colors">Obra Industrial Civil</a>
          </li>
          <li>
            <a href="/src/pages/solutions/industrial/index.html?v=6.0.0" class="block py-2 px-2 text-sm hover:bg-shadow-secondary rounded transition-colors">Instalações Industriais</a>
          </li>
          <li>
            <a href="/src/pages/solutions/projects/index.html?v=6.0.0" class="block py-2 px-2 text-sm hover:bg-shadow-secondary rounded transition-colors">Projetos de Engenharia</a>
          </li>
        </ul>
        ...
        <li><a href="/src/pages/blog/index.html?v=6.0.0" class="block py-2 px-2 hover:bg-shadow-secondary rounded transition-colors">Blog</a></li>
        <li><a href="/src/pages/contact/index.html?v=6.0.0" class="block py-2 px-2 hover:bg-shadow-secondary rounded transition-colors">Contato</a></li>
      </ul>
    `;
